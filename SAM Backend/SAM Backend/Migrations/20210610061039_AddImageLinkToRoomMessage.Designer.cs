...
namespace SAM_Backend.Migrations
{
    ...
    [Migration("20210610061039_AddImageLinkToRoomMessage")]
    partial class AddImageLinkToRoomMessage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SAM_Backend.Models.RoomMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SAM_Backend.Models.RoomMessage", b =>
                {
                    b.HasOne("SAM_Backend.Models.RoomMessage", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId");

                    b.HasOne("SAM_Backend.Models.Room", "Room")
                        .WithMany()
                        .HasForeignKey("RoomId");

                    b.HasOne("SAM_Backend.Models.AppUser", "Sender")
                        .WithMany()
